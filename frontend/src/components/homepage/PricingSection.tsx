    ...
    <div>
      <div className="text-center mb-20">
        ...
        <p className="text-lg text-gray-600">
          Choose a plan that suits your needs. Whether you're just starting out
          or managing a growing team, our transparent pricing ensures you get
          the best value for your investment. No hidden fees, just powerful
          tools to enhance your business relationships.
        </p>
      </div>
